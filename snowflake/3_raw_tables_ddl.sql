...
CREATE OR REPLACE TABLE RAW_COPY_AUDIT (
    AUDIT_ID               STRING NOT NULL,    -- unique identifier for each COPY batch
...
CREATE OR REPLACE TABLE RAW_DISPLAY_CERTIFICATES (
    LMK_KEY STRING,
    ADDRESS1 STRING,
    ADDRESS2 STRING,
    ADDRESS3 STRING,
    ...
    PRIMARY KEY (LMK_KEY),
    FOREIGN KEY (AUDIT_ID) REFERENCES RAW_COPY_AUDIT(AUDIT_ID)
);

CREATE OR REPLACE TABLE RAW_DISPLAY_RECOMMENDATIONS (
    ...
    AUDIT_ID STRING,
    LOAD_TS TIMESTAMP_LTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (LMK_KEY) REFERENCES RAW_DISPLAY_CERTIFICATES(LMK_KEY),
    FOREIGN KEY (AUDIT_ID) REFERENCES RAW_COPY_AUDIT(AUDIT_ID)
);

CREATE OR REPLACE TABLE RAW_NON_DOMESTIC_CERTIFICATES (
  LMK_KEY STRING NOT NULL,
  ADDRESS1 STRING,
  ADDRESS2 STRING,
  ADDRESS3 STRING,
...
CREATE OR REPLACE TABLE RAW_NON_DOMESTIC_RECOMMENDATIONS (
  PAYBACK_TYPE STRING,
  LMK_KEY STRING NOT NULL,
  RECOMMENDATION_ITEM INTEGER,
  RECOMMENDATION_CODE STRING,
  ...
  AUDIT_ID STRING,
  LOAD_TS TIMESTAMP_LTZ DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (LMK_KEY) REFERENCES RAW_NON_DOMESTIC_CERTIFICATES(LMK_KEY),
  FOREIGN KEY (AUDIT_ID) REFERENCES RAW_COPY_AUDIT(AUDIT_ID)
);

CREATE OR REPLACE TABLE RAW_DOMESTIC_CERTIFICATES (
  LMK_KEY STRING NOT NULL,
  ADDRESS1 STRING,
  ADDRESS2 STRING,
  ADDRESS3 STRING,
...
CREATE TABLE RAW_DOMESTIC_RECOMMENDATIONS (
    LMK_KEY STRING NOT NULL,
    ...
    AUDIT_ID STRING,
    LOAD_TS TIMESTAMP_LTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (LMK_KEY) REFERENCES RAW_DOMESTIC_CERTIFICATES(LMK_KEY),
    FOREIGN KEY (AUDIT_ID) REFERENCES RAW_COPY_AUDIT(AUDIT_ID)
);